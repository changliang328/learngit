...
static int bl229x_read_chipid1(struct bl229x_data *bl229x)
{
	...
	if(id == 0x5283)//3182
	{
		BL229X_WIDTH = 72;
		BL229X_HEIGHT = 128;
		SENSOR_DEFAULT_GAIN_V3 = 0x37;
		SENSOR_CAPTURE_GAIN_V3 = 0x37;
		SENSOR_DEFAULT_CONTRAST_V3 = 0x5a;
	...
	}else if(id == 0x5383)//3390
	{
		BL229X_WIDTH = 80;
		BL229X_HEIGHT = 80;	
		SENSOR_DEFAULT_GAIN_V3 = 0x2f;
		SENSOR_CAPTURE_GAIN_V3 = 0x2f;
...
#if(MTK_ANDROID_L == 1)
	bl229x->irq_gpio = GPIO_BL3182_FINGER_RST_PIN;
	bl229x->reset_gpio = GPIO_BL3182_FINGER_EINT_PIN;
	printk("lipeiyang bl229x_parse_dt_gpio\n");
	bl229x->irq_num = CUST_EINT_BL3182_FINGER_EINT_NUM;   //GPIO_BL3182_FINGER_RST_PIN
#else
