...
enum fp_acquired_info {
    FINGERPRINT_ACQUIRED_BTL_BASE = 1100,
    FINGERPRINT_ACQUIRED_WAIT_FINGER_INPUT =FINGERPRINT_ACQUIRED_BTL_BASE+1,
	FINGERPRINT_ACQUIRED_FINGER_DOWN =FINGERPRINT_ACQUIRED_BTL_BASE+2,
	FINGERPRINT_ACQUIRED_FINGER_UP = FINGERPRINT_ACQUIRED_BTL_BASE+3,
	FINGERPRINT_ACQUIRED_INPUT_TOO_LONG = FINGERPRINT_ACQUIRED_BTL_BASE+4,
	FINGERPRINT_ACQUIRED_DUPLICATE_FINGER = FINGERPRINT_ACQUIRED_BTL_BASE+5,
	FINGERPRINT_ACQUIRED_DUPLICATE_AREA = FINGERPRINT_ACQUIRED_BTL_BASE+6,
	FINGERPRINT_ACQUIRED_LOW_COVER = FINGERPRINT_ACQUIRED_BTL_BASE+7,
	FINGERPRINT_ACQUIRED_BAD_IMAGE = FINGERPRINT_ACQUIRED_BTL_BASE+8,
};
...
int32_t btl_hw_writeKeycode(int32_t);
