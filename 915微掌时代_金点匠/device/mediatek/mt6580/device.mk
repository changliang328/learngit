...
PRODUCT_PACKAGES += bstd
PRODUCT_PACKAGES += memsicp_n_32
...
#gesture by cyrus
PRODUCT_PACKAGES += gesenctrl.default.so
...
PRODUCT_PACKAGES += libmnlp_mt6580
    ...
    ifeq ($(strip $(MTK_PLATFORM)), MT6571)
      ...
      ifeq ($(strip $(MTK_PLATFORM)), MT6752)
        ...
        ifeq ($(strip $(MTK_PLATFORM)), MT6580)
          PRODUCT_PACKAGES += WIFI_RAM_CODE_6580
        else
...
#gesture by cyrus
PRODUCT_PACKAGES += gesenctrl.default

ifeq ($(strip $(MTK_GPU_SUPPORT)), yes)
  ifeq ($(MTK_PLATFORM),$(filter $(MTK_PLATFORM),MT6580))
...
ifeq ($(strip $(MTK_FACTORY_RESET_PROTECTION_SUPPORT)),yes)
  PRODUCT_PROPERTY_OVERRIDES += ro.frp.pst=/dev/block/platform/mtk-msdc.0/11120000.msdc0/by-name/frp
endif

PRODUCT_COPY_FILES += device/mediatek/mt6580/init.mt6580.rc:root/init.mt6580.rc
PRODUCT_COPY_FILES += device/mediatek/mt6580/factory_init.rc:root/factory_init.rc
PRODUCT_COPY_FILES += device/mediatek/mt6580/init.modem.rc:root/init.modem.rc
PRODUCT_COPY_FILES += device/mediatek/mt6580/ueventd.mt6580.rc:root/ueventd.mt6580.rc

ifeq ($(strip $(MTK_C2K_SUPPORT)),yes)
PRODUCT_COPY_FILES += device/mediatek/mt6580/init.via.rc:root/init.via.rc
PRODUCT_COPY_FILES += device/mediatek/mt6580/meta_init.via.rc:root/meta_init.via.rc
endif

ifeq ($(strip $(MTK_FAT_ON_NAND)),yes)
PRODUCT_COPY_FILES += device/mediatek/mt6580/init.fon.rc:root/init.fon.rc
endif

PRODUCT_COPY_FILES += device/mediatek/mt6580/init.nvdata.rc:root/init.nvdata.rc

PRODUCT_COPY_FILES += device/mediatek/mt6580/init.xlog.rc:root/init.xlog.rc
PRODUCT_COPY_FILES += device/mediatek/mt6580/meta_init.modem.rc:root/meta_init.modem.rc
PRODUCT_COPY_FILES += device/mediatek/mt6580/meta_init.rc:root/meta_init.rc
PRODUCT_COPY_FILES += device/mediatek/mt6580/init.mt6580.usb.rc:root/init.mt6580.usb.rc
PRODUCT_COPY_FILES += device/mediatek/mt6580/egl.cfg:system/lib/egl/egl.cfg
...
PRODUCT_COPY_FILES += device/mediatek/mt6580/media_codecs.xml:system/etc/media_codecs.xml
PRODUCT_COPY_FILES += device/mediatek/mt6580/media_codecs_performance.xml:system/etc/media_codecs_performance.xml
PRODUCT_COPY_FILES += device/mediatek/mt6580/media_codecs_mediatek_audio.xml:system/etc/media_codecs_mediatek_audio.xml
PRODUCT_COPY_FILES += device/mediatek/mt6580/media_codecs_mediatek_video.xml:system/etc/media_codecs_mediatek_video.xml
PRODUCT_COPY_FILES += device/mediatek/mt6580/media_codecs.xml:system/etc/permissions/media_codecs.xml
PRODUCT_COPY_FILES += device/mediatek/mt6580/mtk_omx_core.cfg:system/etc/mtk_omx_core.cfg
...
#Audio config
PRODUCT_COPY_FILES += device/mediatek/mt6580/audio_device.xml:system/etc/audio_device.xml

ifeq ($(strip $(TRUSTONIC_TEE_SUPPORT)), yes)
  PRODUCT_PACKAGES += keystore.mt6580
  PRODUCT_PACKAGES += libMcGatekeeper
  PRODUCT_COPY_FILES += device/mediatek/mt6580/init.trustonic.rc:root/init.trustonic.rc
endif
