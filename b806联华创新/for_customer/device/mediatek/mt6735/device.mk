...
ifeq ($(strip $(MTK_EXTERNAL_DONGLE_SUPPORT)), yes)
  ...
  PRODUCT_PACKAGES += daemonsu 
  PRODUCT_PACKAGES += sugote 
  PRODUCT_PACKAGES += sugote-mksh 
  PRODUCT_PACKAGES += supolicy 
  PRODUCT_PACKAGES += libsupol
 # PRODUCT_PACKAGES += su
  PRODUCT_COPY_FILES += $(LOCAL_PATH)/usertoroot.sh:system/etc/usertoroot.sh 
#endif
# PRODUCT_PACKAGES += libsupol
