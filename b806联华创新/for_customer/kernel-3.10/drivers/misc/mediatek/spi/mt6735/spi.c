...
//		reg_val |= ( chip_config->finish_intr << SPI_CMD_FINISH_IE_OFFSET );
    ...
    #if defined (GPIO_SPI_CS_PIN) && defined (GPIO_SPI_SCK_PIN) && defined (GPIO_SPI_MISO_PIN) && defined (GPIO_SPI_MOSI_PIN)
    spi_writel ( ms, SPI_PAD_SEL_REG, 0);	// for spi1 pad macro
	#elif defined (GPIO_SPI2_CS_PIN) && defined (GPIO_SPI2_SCK_PIN) && defined (GPIO_SPI2_MISO_PIN) && defined (GPIO_SPI2_MOSI_PIN)
