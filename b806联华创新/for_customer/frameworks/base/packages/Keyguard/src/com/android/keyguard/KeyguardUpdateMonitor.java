...
public class KeyguardUpdateMonitor implements TrustManager.TrustListener {
    ...
    private static final int   MSG_FINGERPRINT_UNMATCH = 350;
   //add blestech end
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MSG_SCREEN_TURNED_ON:
                    ...
                    Log.d(TAG, "MSG_SCREEN_TURNED_ON") ;
                    break;
                ...
                case MSG_FINGERPRINT_UNMATCH:
                  handleFingerUnmatchIntent((Intent) msg.obj);
                  break;
                //add by blestech end		
    ...
    //add by blestech start
    private void handleFingerUnmatchIntent(Intent msg) {

		for (int i = 0; i < mCallbacks.size(); i++) {
            KeyguardUpdateMonitorCallback cb = mCallbacks.get(i).get();
            if (cb != null) {
                cb.onFingerprintMessage(msg.getIntExtra("error_on", -1));
            }
        }
		
        /*if (mFingerprintCallback != null) {
	         mFingerprintCallback.onFingerprintUnmatch(msg);
        }*/
    }
   //add by blestech end
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (Intent.ACTION_TIME_TICK.equals(action)
             ...
             //add by blestech start
                ...
                mHandler.sendMessage(mHandler.obtainMessage(MSG_FINGERPRINT_UNMATCH, intent));
            }
            //add by blestech end
    ...
    private KeyguardUpdateMonitor(Context context) {
        ...
        context.registerReceiver(mBroadcastReceiver, bootCompleteFilter);
         ...
         //add by blestech start
         context.registerReceiver(mBroadcastReceiver, new IntentFilter(FINGERPRINT_UNMATCH_ACTION));
        //add by blestech end
