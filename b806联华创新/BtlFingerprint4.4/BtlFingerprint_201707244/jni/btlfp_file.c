...
*/
const char *strDataFileName = "fingerIndex.dat";
const char *dataIndexFileName= "/data/data/com.btlfinger.fingerprintunlock/fpfile/fingerIndex.dat";
const char *dataFolderPath	  = "/data/data/com.btlfinger.fingerprintunlock/fpfile/";
...
int btl_file_saveTemplate(unsigned char *pTemplateBuf, int template_size, int fid)
{
    ...
    if (fp == NULL) 
    {
    	LOGE("%s, can't open %s", __func__, finger_filename);
        return -10;
    }
