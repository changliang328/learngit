...
enum storage_cmd {
	...
	STORAGE_SYNC_CHECK = 10 << STORAGE_REQ_SHIFT,

	STORAGE_FILE_RENAME  = 11 << STORAGE_REQ_SHIFT,
};
...
/**
 * struct storage_file_rename_req - request format for STORAGE_FILE_RENAME
 * @old_file_name:  Modified file name
 * @new_file_name:  the new name of the file
 */
struct storage_file_rename_req {
	char old_file_name[FILE_NAME_MAX];
