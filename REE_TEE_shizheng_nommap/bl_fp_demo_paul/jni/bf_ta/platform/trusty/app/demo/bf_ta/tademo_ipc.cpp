...
#include <err.h>
#include "./inc/trusty_tademo.h"
#include "./inc/tademo_ipc.h"
#include "bf_core.h"
#include <math.h>

using namespace tademo;
TaDemo *device;
static long int times=0;
...
static tademo_error_t handle_request(uint32_t cmd, uint8_t *in_buf, uint32_t in_buf_size,
	...
	//Analysis data from CA side

	/*bf_core_handler(in_buf, in_buf_size);
	*out_buf_size=in_buf_size;
	out_buf->reset(new uint8_t[*out_buf_size]);
	memcpy(out_buf->get(), in_buf, *out_buf_size);
	*/
