...
public class ManagerPINActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (this.mPatternUtils.getKeyguardStoredPasswordQuality(ActivityManager.getCurrentUser()) >= DevicePolicyManager.PASSWORD_QUALITY_SOMETHING) {
		...
		Log.i(TAG, "getKeyguardStoredPasswordQuality" + mPatternUtils.getKeyguardStoredPasswordQuality(ActivityManager.getCurrentUser()));
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        int quality = this.mPatternUtils.getKeyguardStoredPasswordQuality(ActivityManager.getCurrentUser());
