...
#define REGA_FINGER_TD_THRED_HIGH	0x12
	...
	#define REGA_RX_DACP_LOW			0x1C //
	#define REGA_RX_DACP_HIGH			0x1B
#else
...
#define NEED_NAVI_FUNCTION_DO_DEFAULT_FD
#ifdef    NEED_NAVI_FUNCTION_DO_DEFAULT_FD
#define BF229X_NAV_UP_FLAGS 			(0X1<<15)
#define BF229X_NAV_FLAGS_MASK	(0XFFF)
#define BF229X_NAV_FLAGS_NULL	(0X00)

#define BF229X_NAV_UP_KEY		(0X3<<9)
#define BF229X_NAV_DOWN_KEY		(0X3<<1)
#define BF229X_NAV_LEFT_KEY		(0X1<<7)
#define BF229X_NAV_RIGHT_KEY		(0X1<<4)

#define BF229X_NAV_MOVE_KEY		(0X3<<5 )
#else
#define BF229X_NAV_FLAGS_NULL	(0X00)
#define BF229X_NAV_FLAGS 			(0XF<<8)
#define BF229X_NAV_LEFT_FLAGS 			(0X1<<15)
#define BF229X_NAV_RIGHT_FLAGS 			(0X1<<14)
#define BF229X_NAV_UP_FLAGS 			(0X1<<13)
#define BF229X_NAV_DOWN_FLAGS 			(0X1<<12)
#define BF229X_NAV_FLAGS_MASK	(0XFFF)
#define BF229X_NAV_UP_KEY		(0X3<<9)
#define BF229X_NAV_DOWN_KEY		(0X3<<1)
#define BF229X_NAV_LEFT_KEY		(0X1<<7)
